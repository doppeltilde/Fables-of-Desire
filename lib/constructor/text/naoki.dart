...
class NaokiText1 {
  ...
  List<Speech> textBank = [
    ...
    Speech(
        ...
        mcImage: "transparent"),
    Speech(
        characterName: n, characterText: "Who...?", charImage: "naoki_neutral"),
    Speech(
        characterName: n,
    ...
    Speech(
        characterName: nar,
        characterText:
            "What does it mean to be Naoki? A raven? Something more?",
        mcImage: "mc_sad"),
    Speech(
        characterName: m,
        ...
        mcImage: "mc_neutral"),
    Speech(
        characterName: m, characterText: "You’re Naoki.", mcImage: "mc_happy"),
    Speech(characterName: n, characterText: "But…", mcImage: "transparent"),
    Speech(
        characterName: m,
        characterText:
    ...
    Speech(
        ...
        mcImage: "mc_happy"),
    Speech(characterName: n, characterText: "…", charImage: "naoki_neutral"),
    Speech(
        characterName: n,
        characterText:
            "I suppose that gives me some freedom of interpretation.",
    ...
    Speech(
        characterName: m,
        characterText:
            "I think seeing everything will help you find your place.",
        mcImage: "transparent"),
    Speech(
        characterName: n,
...
class NaokiText2 {
  ...
  List<Speech> textBank = [
    ...
    Speech(
        characterName: m,
        characterText: "W-what? Slow dowcharacterName: n, please!",
        mcImage: "mc_blush"),
    Speech(
        characterName: nar,
        characterText:
    ...
    Speech(
        ...
        mcImage: "transparent"),
    Speech(
        characterName: n, characterText: "I’m sorry.", charImage: "naoki_sad"),
    Speech(
        characterName: m,
...
class NaokiText3 {
  ...
  List<Speech> textBank = [
    ...
    Speech(
        characterName: m, characterText: "Here we are!", mcImage: "mc_happy"),
    Speech(
        characterName: n,
    ...
    Speech(
        characterName: m,
        characterText:
            "As a hucharacterName: n, you should bathe and eat often.",
        mcImage: "mc_neutral"),
    Speech(
        characterName: n,
        characterText:
    ...
    Speech(
        characterName: m,
        characterText:
            "Well, yes, but… UcharacterName: m, I think this is a good opportunity for you to do something on your own.",
        mcImage: "mc_neutral"),
    Speech(
        characterName: m,
...
class NaokiText4 {
  ...
  List<Speech> textBank = [
    ...
    Speech(
        ...
        mcImage: "transparent"),
    Speech(characterName: n, characterText: "Goddess?", mcImage: "transparent"),
    Speech(
        characterName: nar,
        characterText:
...
class NaokiText5 {
  ...
  List<Speech> textBank = [
    ...
    Speech(
        ...
        mcImage: "mc_sad"),
    Speech(characterName: n, characterText: "Sure…", mcImage: "transparent"),
    Speech(
        characterName: nar,
        characterText:
    ...
    Speech(
        ...
        charImage: "naoki_happy"),
    Speech(characterName: m, characterText: "Absolutely!", mcImage: "mc_happy"),
    Speech(
        characterName: nar,
        characterText:
...
class NaokiText7 {
  ...
  List<Speech> textBank = [
    ...
    Speech(
        characterName: n,
        characterText:
            "Yes. I should always be aware of any changes in the terraicharacterName: n, no matter how small.",
        charImage: "naoki_neutral"),
    Speech(
        characterName: m,
    ...
    Speech(
        ...
        charImage: "naoki_happy"),
    Speech(characterName: m, characterText: "Uh, what?", mcImage: "mc_sad"),
    Speech(
        characterName: n,
        characterText:
...
class NaokiText8 {
  ...
  List<Speech> textBank = [
    ...
    Speech(
        ...
        mcImage: "transparent"),
    Speech(
        characterName: n, characterText: "Okay.", charImage: "naoki_neutral"),
  ];
}
...
class NaokiText9 {
  ...
  List<Speech> textBank = [
    ...
    Speech(
        ...
        charImage: "naoki_sad"),
    Speech(characterName: m, characterText: "O-oh do I?", mcImage: "mc_blush"),
    Speech(
        characterName: n,
...
class NaokiText10 {
  ...
  List<Speech> textBank = [
    ...
    Speech(
        ...
        mcImage: "transparent"),
    Speech(characterName: m, characterText: "Naoki!", mcImage: "mc_happy"),
    Speech(
        characterName: nar,
        characterText:
    ...
    Speech(
        ...
        mcImage: "transparent"),
    Speech(characterName: n, characterText: "Mm…", mcImage: "transparent"),
    Speech(
        characterName: nar,
        characterText:
    ...
    Speech(
        ...
        mcImage: "transparent"),
    // TODO screen shake
    Speech(characterName: n, characterText: "Ah!", charImage: "naoki_sad"),
    Speech(
        characterName: m,
    ...
    Speech(
        characterName: n,
        characterText:
            "Oh… I looked through the various scribbles and drawings.",
        charImage: "naoki_neutral"),
    Speech(
        characterName: m, characterText: "The… books?", mcImage: "mc_neutral"),
    // TODO screen shake
    Speech(
        characterName: n,
    ...
    Speech(
        characterName: m,
        characterText:
            "It sure is. What you saw was the shrine collectiocharacterName: n, or library of books.",
        mcImage: "mc_neutral"),
    Speech(
        characterName: n,
    ...
    Speech(
        characterName: n,
        characterText: "McharacterName: m, yes…",
        charImage: "naoki_neutral"),
    Speech(
        characterName: nar,
        characterText:
            "A little distracted, are we? At least he’s having fucharacterName: n, ha ha…",
        mcImage: "mc_happy"),
  ];
}
...
class NaokiText11 {
  ...
  List<Speech> textBank = [
    ...
    Speech(
        ...
        mcImage: "mc_neutral"),
    Speech(characterName: n, characterText: "Hmm…", mcImage: "transparent"),
    Speech(
        characterName: n,
        characterText:
    ...
    Speech(
        ...
        mcImage: "mc_neutral"),
    Speech(characterName: n, characterText: "Then…", charImage: "naoki_sad"),
    Speech(
        characterName: n,
        characterText:
    ...
    Speech(
        ...
        charImage: "naoki_neutral"),
    Speech(characterName: m, characterText: "Ready?", mcImage: "mc_neutral"),
    Speech(
        characterName: n,
        characterText:
    ...
    Speech(
        ...
        mcImage: "transparent"),
    Speech(
        characterName: m, characterText: "Like this?", mcImage: "transparent"),
    Speech(characterName: n, characterText: "Yes.", mcImage: "transparent"),
    Speech(
        characterName: nar,
        characterText:
    ...
    Speech(
        ...
        charImage: "naoki_happy"),
    // screen shake
    Speech(characterName: m, characterText: "Wha?!", mcImage: "mc_blush"),
    Speech(characterName: m, characterText: "H-hey!", mcImage: "transparent"),
    Speech(characterName: n, characterText: "I win.", mcImage: "transparent"),
    Speech(
        characterName: m,
    ...
    Speech(
        ...
        mcImage: "transparent"),
    Speech(characterName: m, characterText: "Gah…", mcImage: "mc_sad"),
    Speech(
        characterName: m,
    ...
    Speech(
        ...
        mcImage: "transparent"),
    Speech(
        characterName: n, characterText: "I sure am.", mcImage: "transparent"),
    Speech(
        characterName: m,
        characterText:
    ...
    Speech(
        ...
        mcImage: "transparent"),
    Speech(characterName: m, characterText: "Sigh…", mcImage: "transparent"),
    Speech(
        characterName: m,
    ...
    Speech(
        ...
        mcImage: "transparent"),
    Speech(characterName: n, characterText: "Latent?", mcImage: "transparent"),
    Speech(
        characterName: m,
        characterText:
    ...
    Speech(
        characterName: n, characterText: "Ah…", charImage: "raven_naoki_blush"),
    Speech(
        characterName: m,
    ...
    Speech(
        ...
        charImage: "raven_naoki_neutral"),
    Speech(characterName: m, characterText: "Let’s.", mcImage: "transparent"),
    Speech(
        characterName: nar,
        characterText:
...
class NaokiText12 {
  ...
  List<Speech> textBank = [
    ...
    Speech(
        ...
        charImage: "raven_naoki_happy"),
    Speech(characterName: m, characterText: "I do not!", mcImage: "mc_blush"),
...
class NaokiText13 {
  ...
  List<Speech> textBank = [
    ...
    Speech(
        ...
        mcImage: "mc_happy"),
    Speech(characterName: m, characterText: "Here.", mcImage: "mc_neutral"),
  ];
}
...
class NaokiText14 {
  ...
  List<Speech> textBank = [
    ...
    Speech(
        ...
        mcImage: "mc_happy"),
    Speech(characterName: n, characterText: "Study?", charImage: "naoki_sad"),
    Speech(
        characterName: m,
        characterText:
    ...
    Speech(
        characterName: m,
        characterText:
            "And if we go to this page… this one is pronounced ‘oh.’",
        charImage: "naoki_neutral"),
    Speech(
        characterName: m,
        characterText: "And this one here is—",
        mcImage: "mc_neutral"),
    Speech(characterName: n, characterText: "‘Ki.’", mcImage: "transparent"),
    Speech(
        characterName: m, characterText: "That’s right!", mcImage: "mc_happy"),
    Speech(characterName: n, characterText: "My name.", mcImage: "transparent"),
    Speech(
        characterName: m,
        characterText:
...
class NaokiText15 {
  ...
  List<Speech> textBank = [
    ...
    Speech(
        ...
        mcImage: "transparent"),
    Speech(characterName: m, characterText: "H-hello?", mcImage: "mc_frown"),
    // screen shake
    // Naoki appear
    Speech(characterName: n, characterText: "MC!", charImage: "naoki_frown"),
    Speech(
        characterName: m,
    ...
    Speech(
        characterName: nar,
        characterText:
            "I skim the page, increasingly confused the more I read.",
        mcImage: "transparent"),
    Speech(
        characterName: m,
        characterText:
    ...
    Speech(
        ...
        charImage: "naoki_sad"),
    Speech(
        characterName: m, characterText: "What is it?", mcImage: "mc_neutral"),
    Speech(
        characterName: n,
        characterText:
    ...
    Speech(
        characterName: n,
        characterText:
            "There are so many stories of humans in your collection.",
        charImage: "naoki_neutral"),
    Speech(
        characterName: m,
    ...
    Speech(characterName: m, characterText: "Um… yes?", mcImage: "mc_sad"),
    Speech(
        characterName: n,
    ...
    Speech(
        ...
        mcImage: "transparent"),
    // screen shake
    Speech(characterName: m, characterText: "Jeez…", mcImage: "mc_happy"),
  ];
}
...
class NaokiText16 {
  ...
  List<Speech> textBank = [
    ...
    Speech(
        ...
        mcImage: "transparent"),
    Speech(characterName: n, characterText: "!", charImage: "naoki_frown"),
    Speech(characterName: n, characterText: "MC…!", mcImage: "transparent"),
    // screen shake
    Speech(
        characterName: m,
        characterText: "Coming! What’s wrong?",
        mcImage: "mc_frown"),
    Speech(characterName: n, characterText: "A-ah…", charImage: "naoki_sad"),
    Speech(
        characterName: nar,
    ...
    Speech(
        ...
        mcImage: "mc_happy"),
    Speech(characterName: n, characterText: "Um…", charImage: "naoki_neutral"),
    Speech(
        characterName: m, characterText: "Like this.", mcImage: "transparent"),
    Speech(
        characterName: nar,
    ...
    Speech(
        ...
        charImage: "naoki_frown"),
    Speech(characterName: m, characterText: "Don’t…", mcImage: "transparent"),
    Speech(
        characterName: m,
    ...
    Speech(
        ...
        mcImage: "transparent"),
    Speech(
        characterName: m, characterText: "Appreciated.", mcImage: "mc_happy"),
  ];
}
...
class NaokiText17 {
  ...
  List<Speech> textBank = [
    ...
    Speech(
        ...
        charImage: "naoki_frown"),
    Speech(
        characterName: n, characterText: "Per… haps…", mcImage: "transparent"),
    Speech(
        characterName: n,
    ...
    Speech(
        ...
        mcImage: "mc_neutral"),
    Speech(characterName: n, characterText: "Okay.", mcImage: "transparent"),
    Speech(
        characterName: m,
    ...
    // todo bg pond, day
    Speech(characterName: m, characterText: "Here it is.", mcImage: "mc_happy"),
    Speech(
        characterName: n,
    ...
    Speech(
        ...
        mcImage: "transparent"),
    Speech(characterName: n, characterText: "May I?", charImage: "naoki_happy"),
    Speech(
        characterName: m, characterText: "I… guess…", mcImage: "transparent"),
    Speech(
        characterName: nar,
        characterText:
    ...
    Speech(
        ...
        mcImage: "mc_neutral"),
    Speech(characterName: n, characterText: "What?", charImage: "naoki_sad"),
    Speech(
        characterName: m,
        characterText:
    ...
    Speech(
        ...
        mcImage: "transparent"),
    Speech(characterName: m, characterText: "Yes.", mcImage: "mc_sad"),
    Speech(
        characterName: n,
    ...
    Speech(
        ...
        charImage: "naoki_sad"),
    Speech(characterName: m, characterText: "Naoki…", mcImage: "mc_sad"),
    Speech(
        characterName: nar,
        characterText:
    ...
    Speech(
        ...
        mcImage: "transparent"),
    Speech(characterName: m, characterText: "Oh? Yes?", mcImage: "transparent"),
    Speech(
        characterName: nar,
        characterText:
...
class NaokiText18 {
  ...
  List<Speech> textBank = [
    ...
    Speech(
        ...
        charImage: "raven_naoki_sad"),
    // todo bg room, night
    Speech(characterName: m, characterText: "Naoki.", mcImage: "mc_frown"),
    Speech(
        characterName: n,
    ...
    Speech(
        ...
        charImage: "raven_naoki_neutral"),
    Speech(
        characterName: n, characterText: "Oh!", charImage: "raven_naoki_blush"),
    Speech(
        characterName: n,
    ...
    Speech(
        ...
        mcImage: "mc_neutral"),
    Speech(
        characterName: n, characterText: "No!", charImage: "raven_naoki_frown"),
    // todo screen shake
    Speech(
        characterName: n,
...
class NaokiText19 {
  ...
  List<Speech> textBank = [
    ...
    Speech(
        ...
        charImage: "naoki_happy"),
    Speech(characterName: m, characterText: "You… can?", mcImage: "mc_sad"),
    Speech(
        characterName: n,
        characterText:
    ...
    Speech(
        ...
        mcImage: "transparent"),
    Speech(
        characterName: m, characterText: "Here we are.", mcImage: "mc_neutral"),
    Speech(
        characterName: nar,
        characterText:
    ...
    Speech(
        ...
        mcImage: "mc_sad"),
    Speech(characterName: m, characterText: "Thank you!", mcImage: "mc_happy"),
    Speech(
        characterName: n,
    ...
    Speech(characterName: n, characterText: "...!", charImage: "naoki_frown"),
    // screen shake
    Speech(characterName: n, characterText: "Oof!", mcImage: "mc_blush"),
    Speech(characterName: m, characterText: "Naoki!", mcImage: "transparent"),
    ...
    Speech(
        ...
        mcImage: "mc_happy"),
    Speech(characterName: m, characterText: "Goodbye!", mcImage: "transparent"),
...
class NaokiText20 {
  ...
  List<Speech> textBank = [
    ...
    Speech(
        ...
        mcImage: "mc_sad"),
    // screen shake
    Speech(characterName: m, characterText: "Ah?!", mcImage: "mc_sad"),
    Speech(
        characterName: nar,
    ...
    Speech(
        ...
        mcImage: "transparent"),
    Speech(characterName: m, characterText: "What…?", mcImage: "transparent"),
    Speech(
        characterName: nar,
        characterText:
    ...
    Speech(
        characterName: nar,
        characterText:
            "He releases my hand and tucks his arms into his sleeves.",
        mcImage: "transparent"),
    Speech(
        characterName: m,
    ...
    Speech(
        ...
        mcImage: "transparent"),
    Speech(characterName: n, characterText: "You…", charImage: "naoki_sad"),
    Speech(
        characterName: n,
    ...
    Speech(
        ...
        charImage: "naoki_sad"),
    Speech(characterName: n, characterText: "I just…", mcImage: "transparent"),
    ...
    Speech(characterName: m, characterText: "Naoki.", mcImage: "mc_neutral"),
    Speech(
        characterName: m,
        characterText:
    ...
    Speech(
        ...
        charImage: "naoki_frown"),
    Speech(characterName: m, characterText: "What?", mcImage: "mc_frown"),
    Speech(
        characterName: n,
    ...
    Speech(
        ...
        mcImage: "mc_frown"),
    Speech(characterName: n, characterText: "Please.", charImage: "naoki_sad"),
    Speech(
        characterName: nar,
        characterText:
